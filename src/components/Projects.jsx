import pricingImg from '../assets/pricing_redesign_isometric.jpg';
import productImg from '../assets/product_design_isometric.jpg';
    ...
    <section className="w-full max-w-7xl mx-auto px-6 py-16 md:py-24" aria-labelledby="projects-heading">
      ...
      <div className="space-y-12 md:space-y-16">
        {projects.map((project, idx) => (
          <div 
            key={idx}
            className="bg-white dark:bg-zinc-900 rounded-[2rem] p-8 md:p-12 shadow-[0_25px_60px_rgba(0,0,0,0.04)] dark:shadow-[0_25px_60px_rgba(0,0,0,0.25)] border border-zinc-100/50 dark:border-zinc-800/40 transition-all duration-300 hover:shadow-[0_30px_70px_rgba(0,0,0,0.08)] dark:hover:shadow-[0_30px_70px_rgba(0,0,0,0.3)]"
          >
              ...
              <div className="lg:col-span-6 flex flex-col justify-between h-full space-y-8">
                <div>
                  ...
                  <div className="flex items-center space-x-3 text-xs font-mono tracking-widest text-zinc-400 dark:text-zinc-500 uppercase">
                    <span className="text-zinc-800">{project.id}</span>
                  ...
                  {/* Description */}
                  <p className="text-zinc-900 dark:text-zinc-400 mt-6 leading-relaxed font-normal text-sm md:text-base">
                    {project.description}
                  </p>
                </div>
